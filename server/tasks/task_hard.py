...
TASK_DATA = {'task_id': 'bug_triage_hard',
 'step_budget': 120,
 ...
 'tickets': [{'ticket_id': 'BUG-3001',
             ...
             {'ticket_id': 'BUG-3016',
              'title': 'ios-app incident pattern 16',
              'description': 'Observed issue in mobile-app affecting user workflows. Signal '
              ...
              'suspected_duplicate_ids': []},
             {'ticket_id': 'BUG-3017',
              'title': 'android-app incident pattern 17',
              'description': 'Observed issue in mobile-app affecting user workflows. Signal '
                             'quality is high and triage is required.',
              'reporter_type': 'qa',
              'service': 'mobile-app',
              ...
              'suspected_duplicate_ids': []},
             {'ticket_id': 'BUG-3018',
              'title': 'database incident pattern 18',
              'description': 'Observed issue in analytics affecting user workflows. Signal quality '
                             'is low and triage is required.',
              'reporter_type': 'monitoring',
              'service': 'analytics',
              ...
              'suspected_duplicate_ids': []},
             {'ticket_id': 'BUG-3019',
              'title': 'cache incident pattern 19',
              'description': 'Observed issue in infra affecting user workflows. Signal quality is '
                             'high and triage is required.',
              'reporter_type': 'user',
              'service': 'infra',
             ...
             {'ticket_id': 'BUG-3020',
              ...
              'suspected_duplicate_ids': []},
             {'ticket_id': 'BUG-3021',
              'title': 'api-gateway incident pattern 21',
              'description': 'Observed issue in api affecting user workflows. Signal quality is '
                             'high and triage is required.',
              'reporter_type': 'monitoring',
              'service': 'api',
              ...
              'suspected_duplicate_ids': []},
             {'ticket_id': 'BUG-3022',
              'title': 'auth-service incident pattern 22',
              'description': 'Observed issue in auth affecting user workflows. Signal quality is '
                             'high and triage is required.',
              'reporter_type': 'user',
              'service': 'auth',
             ...
             {'ticket_id': 'BUG-3023',
              'title': 'user-service incident pattern 23',
              'description': 'Observed issue in identity affecting user workflows. Signal quality '
                             'is high and triage is required.',
              'reporter_type': 'qa',
              'service': 'identity',
              ...
              'suspected_duplicate_ids': []},
             {'ticket_id': 'BUG-3024',
              'title': 'payment-service incident pattern 24',
              'description': 'Observed issue in payments affecting user workflows. Signal quality '
                             'is low and triage is required.',
              'reporter_type': 'monitoring',
              'service': 'payments',
              ...
              'suspected_duplicate_ids': []},
             {'ticket_id': 'BUG-3025',
              'title': 'web-app incident pattern 25',
              'description': 'Observed issue in web-app affecting user workflows. Signal quality '
                             'is high and triage is required.',
              'reporter_type': 'user',
              'service': 'web-app',
              ...
              'attachments_count': 1,
              'suspected_duplicate_ids': []}],
 'ground_truths': [{'ticket_id': 'BUG-3001',
                    'true_severity': 'sev0',
                    'true_priority': 'p0',
